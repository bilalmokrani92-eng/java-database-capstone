...
private String password;// 6. 'phone' field:
//    - Type: private String
//    - Description:
...
private String phone;// 7. 'availableTimes' field:
...
public Doctor(){}
public Doctor(Long id, String name, String email, String phone,String password){
    this.id=id;
    this.name=name;
    this.email=email;
    this.phone=phone;
